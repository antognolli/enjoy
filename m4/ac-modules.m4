...
dnl AC_EJY_CHECK_PKG(name, lib [>= version], [action-if, [action-not]])
...
dnl AC_EJY_OPTIONAL_MODULE(name, [initial-status, [check-if-enabled]])
...
dnl
AC_DEFUN([AC_EJY_OPTIONAL_MODULE],
[
# ----------------------------------------------------------------------
